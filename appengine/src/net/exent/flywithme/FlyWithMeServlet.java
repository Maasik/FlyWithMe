...
public class FlyWithMeServlet extends HttpServlet {
    private static final Logger log = Logger.getLogger(FlyWithMeServlet.class.getName());
        ...
        try (DataInputStream inputStream = new DataInputStream(request.getInputStream()); DataOutputStream outputStream = new DataOutputStream(response.getOutputStream())) {
            ...
            switch (operation) {
                ...
                case 3:
                    ...
                    responseCode = NoaaHandler.getMeteogramAndSounding(inputStream, outputStream);
                    // output:
